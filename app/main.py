...
<head>
    ...
    <style>
        ...
        .form-section { flex: 1; padding: 20px; background-color: #1e1e1e; }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        th { color: #d32f2f; text-align: left; padding: 10px; border-bottom: 2px solid #d32f2f; font-weight: bold; }
        td { padding: 10px; border-bottom: 1px solid #333333; color: #e0e0e0; }
        input { width: 100%; padding: 8px; margin: 10px 0; border: 1px solid #444444; box-sizing: border-box; background-color: #2d2d2d; color: #ffffff; border-radius: 4px; }
        input:focus { border-color: #d32f2f; outline: none; background-color: #333333; }
        label { color: #aaaaaa; font-weight: bold; display: block; }
        ...
        .btn-save { background: #ffffff; color: #121212; border: none; padding: 10px 30px; cursor: pointer; border-radius: 4px; font-weight: bold; transition: background 0.2s; }
        .btn-save:hover { background: #d32f2f; color: white; }
        .btn-cancel { background: transparent; color: #aaaaaa; border: 1px solid #444444; padding: 10px 30px; cursor: pointer; border-radius: 4px; font-weight: bold; transition: all 0.2s; }
        .btn-cancel:hover { background: #444444; color: white; }
